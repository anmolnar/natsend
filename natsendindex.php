...
/**
 *	\file       natsend/natsendindex.php
 *	\ingroup    natsend
 *	\brief      Home page of natsend top menu
 */
...
$langs->loadLangs(array("natsend@natsend"));

$action=GETPOST('action', 'alpha');


// Security check
//if (! $user->rights->natsend->myobject->read) accessforbidden();
...
llxHeader("", $langs->trans("NatsendArea"));

print load_fiche_titre($langs->trans("NatsendArea"), '', 'natsend.png@natsend');
...
// Draft MyObject
if (! empty($conf->natsend->enabled) && $user->rights->natsend->read)
{
	$langs->load("orders");
