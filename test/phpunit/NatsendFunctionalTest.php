...
/**
 * \file    test/functional/NatsendFunctionalTest.php
 * \ingroup natsend
 ...
 * @package Testnatsend
 */
class NatsendFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/natsend/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('natsend/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/natsend/admin/about.php');
		$this->authenticate();
		return $this->assertContains('natsend/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('natsendwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
        ...
        return $this->assertContains(
			'interface_99_modNatsend_NatsendTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
        ...
        return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modNatsend_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
